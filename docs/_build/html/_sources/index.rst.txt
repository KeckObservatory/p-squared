...
-----------------------
The Userinfo API adds user specific information for the person running the application. This is how the UI knows who is 'signed in' to 
...
For example, when edding an employee entry as 'WFH' their cell phone number is automatically added to the comment field.
