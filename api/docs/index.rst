...
* SVN location for the backend API and documentation: svnserver.keck.hawaii.edu/svnrepos/trunk/webtools/api/peoplePortal
* Database is located at: mysqlserver.keck.hawaii.edu, keckOperations database
